                    ...
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="badge bg-secondary">{{ $category->news_count }}</span></td>
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <form action="{{ route('news.categories.destroy', $category->id) }}" method="POST" onsubmit="return confirm('Are you sure? This will fail if the category has news.')">
                                                    @csrf
                                                    @method('DELETE')
