...
<div class="row">
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('notices.categories.store') }}" method="POST">
                    @csrf
                    <div class="row g-3">
                        <div class="col-12">
            ...
            <div class="card-header py-3">
                <div class="row align-items-center g-3">
                    <div class="col-12 col-lg-6">
                        <h5 class="mb-0">Notice Categories</h5>
                    </div>
                    ...
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="badge bg-secondary">{{ $category->notices_count }}</span></td>
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <form action="{{ route('notices.categories.destroy', $category->id) }}" method="POST" onsubmit="return confirm('Are you sure? This will fail if the category has notices.')">
                                                    @csrf
                                                    @method('DELETE')
