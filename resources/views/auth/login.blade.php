                                    ...
                                    <div class="form-body">
                                        ...
                                        <form class="row g-3" method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="email" class="form-control" id="inputEmailAddress" name="email" placeholder="jhon@example.com" value="{{ old('email') }}" required autofocus>
                                            </div>
                                            <div class="col-12">
